...
knitr::include_graphics("../images/stephencurry1.jpg")
```
**Stephen Curry**
...
```{r out.width="80%", echo=FALSE, fig.align="center"}
knitr::include_graphics("../images/draymondgreen.jpg")
```
...
```{r out.width="80%", echo=FALSE, fig.align="center"}
knitr::include_graphics("../images/andreiguodala.jpg")
```
**Andre Iguodala**
...
```{r out.width="80%", echo=FALSE, fig.align="center"}
knitr::include_graphics("../images/kevindurant.jpg")
```
**Kevin Durant**
...
```{r out.width="80%", echo=FALSE, fig.align="center"}
knitr::include_graphics("../images/klaythompson.jpg")
```
